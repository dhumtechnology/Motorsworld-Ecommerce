    ...
    <div data-category-image>
        ...
        @if ($category?->image)
            <div class="mb-3 flex items-center gap-3 rounded border border-border bg-secondary p-3">
                <img src="{{ $category->image }}" alt="" class="h-16 w-16 rounded object-cover border border-border">
...
<script>
    (function () {
        const root = document.querySelector('[data-category-image]');
        if (!root) return;
