                ...
                <tbody class="divide-y divide-border">
                    @forelse ($brands as $brand)
                        <tr class="hover:bg-secondary/60 transition-colors">
                            <td class="px-5 py-3">
                                <input type="checkbox" value="{{ $brand->id }}" data-row-checkbox class="h-4 w-4 rounded border-border-strong bg-surface text-primary focus:ring-primary">
                            </td>
                            <td class="px-5 py-3">
                                @if ($brand->image)
                    ...
                    @empty
                        <tr><td colspan="5" class="px-5 py-12 text-center text-muted">No se encontraron marcas.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
