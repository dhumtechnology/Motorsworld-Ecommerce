...
@section('title', 'Respuesta a tu mensaje — '.$appName)
...
@section('content')
    ...
    <p style="margin:0 0 16px;font-size:16px;line-height:1.6;color:#404040;">
        Te respondemos respecto a tu mensaje
        <strong style="color:#111111;">{{ $code }}</strong>.
    </p>
...
@section('aside')
    Código: {{ $code }}. Esta es una respuesta oficial de {{ $appName }} a tu mensaje de contacto.
@endsection
