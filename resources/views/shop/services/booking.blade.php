...
@section('title', 'Agendar servicio — '.config('app.name'))
...
<section class="bg-neutral-50 border-b border-neutral-100">
    <div class="mx-auto max-w-3xl px-4 md:px-8 py-12 md:py-16 text-center">
        ...
        <p class="mt-5 text-sm md:text-base leading-relaxed text-neutral-600 text-center">
            Si aún no sabes qué servicio necesitas, puedes revisar todos los servicios que ofrecemos en el taller Motoworld. Explora cada tipo de servicio y sus paquetes para encontrar la opción que mejor se adapte a tus necesidades.
        </p>
        <br>
        <a
            href="{{ route('shop.services.list') }}"
            class="inline-flex items-center justify-center rounded-lg bg-neutral-900 px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-white transition hover:bg-neutral-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-700 focus-visible:ring-offset-2">
