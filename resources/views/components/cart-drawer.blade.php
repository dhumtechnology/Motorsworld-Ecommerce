...
>
    <button
        ...
        data-cart-icon
        @click="toggle()"
        class="relative inline-flex h-full min-w-11 items-center justify-center px-3 text-white transition-colors hover:bg-orange-600"
                ...
                <div class="border-t border-neutral-200 bg-neutral-50 px-4 py-4 sm:px-5">
                    ...
                    <div class="flex flex-col gap-2.5">
                        ...
                        <a
                            ...
                            @if ($hasItems) @click="closeDrawer()" @endif
