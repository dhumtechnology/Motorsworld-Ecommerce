...
class CatalogSeeder extends Seeder
{
    ...
    private function seedCategories(): Collection
    {
        ...
        $definitions = [
            ...
            'Accesorios' => [
                'description' => 'Cascos, guantes, chaquetas y equipamiento de protección.',
                'image' => '/images/home/need-accesorios.png',
            ],
            'Repuestos' => [
                'description' => 'Filtros, pastillas de freno, transmisión y consumibles.',
                'image' => '/images/home/need-repuestos.png',
            ],
            'Baterías' => [
                'description' => 'Baterías selladas y de gel para todo tipo de motocicletas.',
                'image' => '/images/home/need-baterias.png',
            ],
            'Lubricantes' => [
                'description' => 'Aceites de motor, lubricantes de cadena y fluidos técnicos.',
                'image' => '/images/home/need-repuestos.png',
            ],
            'Neumáticos' => [
                'description' => 'Neumáticos delanteros y traseros para uso urbano y trail.',
    ...
    {
        $images = [
            'Yamaha' => 'https://placehold.co/120x120/003366/ffffff/png?text=Yamaha',
            'Honda' => 'https://placehold.co/120x120/CC0000/ffffff/png?text=Honda',
            'Kawasaki' => 'https://placehold.co/120x120/009933/ffffff/png?text=Kawasaki',
            'Suzuki' => 'https://placehold.co/120x120/003399/ffffff/png?text=Suzuki',
            'BMW Motorrad' => 'https://placehold.co/120x120/0066B1/ffffff/png?text=BMW',
            'KTM' => 'https://placehold.co/120x120/FF6600/ffffff/png?text=KTM',
            'Ducati' => 'https://placehold.co/120x120/CC0000/ffffff/png?text=Ducati',
            'Bajaj' => 'https://placehold.co/120x120/0066CC/ffffff/png?text=Bajaj',
    ...
    private function seedProducts(
        ...
        $products = [
            ...
            [
                ...
                'images' => 'moto',
                'variants' => [
                    ['name' => 'Negro', 'colors' => ['Negro'], 'stock' => 2],
                    ['name' => 'Naranja', 'colors' => ['Naranja'], 'stock' => 1],
                ],
            ],
            [
                'sku' => 'MW-MOTO-002',
            ...
            [
                ...
                'images' => 'moto',
                'variants' => [
                    ['name' => 'Blanco', 'colors' => ['Blanco'], 'stock' => 1],
                    ['name' => 'Negro', 'colors' => ['Negro'], 'stock' => 0],
                    ['name' => 'Naranja', 'colors' => ['Naranja'], 'stock' => 0],
                ],
            ],
            ...
            [
                'sku' => 'MW-ACC-001',
                'name' => 'Casco integral DOT/ECE',
                'description' => 'Casco integral certificado DOT/ECE. Visera anti-rayas y ventilación superior.',
                'category' => 'Accesorios',
                'brand' => 'Universal',
                'model' => 'Genérico',
                'price' => 459.90,
                ...
                'images' => 'accessory',
                'variants' => [
                    ['name' => 'Negro', 'colors' => ['Negro'], 'stock' => 10],
                    ['name' => 'Rojo', 'colors' => ['Rojo'], 'stock' => 8],
                    ['name' => 'Azul', 'colors' => ['Azul'], 'stock' => 7],
                ],
            ],
            [
                'sku' => 'MW-ACC-002',
                'name' => 'Guantes de verano',
                'description' => 'Guantes de verano con protección en nudillos y palma reforzada.',
                'category' => 'Accesorios',
                'brand' => 'Universal',
                'model' => 'Genérico',
                'price' => 89.90,
            ...
            [
                'sku' => 'MW-ACC-003',
                'name' => 'Chaqueta textil Yamaha YZF-R3',
                'description' => 'Chaqueta textil compatible con Yamaha YZF-R3. Incluye protecciones CE en hombros y codos.',
                'category' => 'Accesorios',
                'brand' => 'Yamaha',
                'model' => 'YZF-R3',
                'price' => 320.00,
            ...
            [
                'sku' => 'MW-ACC-004',
                'name' => 'Baúl trasero 35 L PCX 160',
                'description' => 'Baúl trasero 35 L para Honda PCX 160. Incluye soporte y kit de montaje.',
                'category' => 'Accesorios',
                'brand' => 'Honda',
                'model' => 'PCX 160',
                'price' => 275.50,
            ...
            [
                'sku' => 'MW-REP-001',
                'name' => 'Filtro de aceite Yamaha MT-07',
                'description' => 'Filtro de aceite original compatible con Yamaha MT-07.',
                'category' => 'Repuestos',
                'brand' => 'Yamaha',
                'model' => 'MT-07',
                'price' => 45.00,
            ...
            [
                'sku' => 'MW-REP-002',
                'name' => 'Pastillas de freno Honda XR190L',
            ...
            [
                'sku' => 'MW-REP-003',
                'name' => 'Kit cadena y piñones GN125',
                'description' => 'Kit de cadena y piñones 428 para Suzuki GN125.',
                'category' => 'Repuestos',
                'brand' => 'Suzuki',
                'model' => 'GN125',
                'price' => 22.00,
            ...
            [
                ...
                'description' => 'Bujía NGK estándar compatible con motos de baja cilindrada.',
                'category' => 'Repuestos',
                'brand' => 'Universal',
                'model' => 'Genérico',
                'price' => 15.00,
            ...
            [
                'sku' => 'MW-BAT-001',
                'name' => 'Batería sellada 12V 5Ah',
                'description' => 'Batería sellada 12 V 5 Ah. Uso universal para scooters y motos ligeras.',
                'category' => 'Baterías',
                'brand' => 'Universal',
                'model' => 'Genérico',
                'price' => 120.00,
            ...
            [
                'sku' => 'MW-BAT-002',
                'name' => 'Batería gel Yamaha NMAX 155',
                'description' => 'Batería de gel compatible con Yamaha NMAX 155.',
                'category' => 'Baterías',
                'brand' => 'Yamaha',
                'model' => 'NMAX 155',
                'price' => 145.00,
            ...
            [
                'sku' => 'MW-BAT-003',
                'name' => 'Batería Honda CBR500R',
                'description' => 'Batería de alto rendimiento para Honda CBR500R.',
                'category' => 'Baterías',
                'brand' => 'Honda',
                'model' => 'CBR500R',
                'price' => 155.00,
            ...
            [
                'sku' => 'MW-LUB-001',
                'name' => 'Aceite sintético 10W-40 1L',
                'description' => 'Aceite sintético 10W-40 1 L. Formulación para motores 4T de alto rendimiento.',
            ...
            [
                'sku' => 'MW-LUB-002',
                'name' => 'Lubricante de cadena 400ml',
                'description' => 'Lubricante de cadena en aerosol 400 ml. Resistente al agua y polvo.',
                'category' => 'Lubricantes',
                'brand' => 'Universal',
                'model' => 'Genérico',
                'price' => 32.00,
            ...
            [
                'sku' => 'MW-NEU-001',
                'name' => 'Neumático trasero 120/70-17',
                'description' => 'Neumático trasero 120/70-17. Compuesto mixto para uso urbano y carretera.',
                'category' => 'Neumáticos',
                'brand' => 'Universal',
                'model' => 'Genérico',
                'price' => 280.00,
            ...
            [
                'sku' => 'MW-NEU-002',
                'name' => 'Neumático trail BMW F 850 GS',
                'description' => 'Neumático trail 110/80-19 compatible con BMW F 850 GS.',
                'category' => 'Neumáticos',
                'brand' => 'BMW Motorrad',
                'model' => 'F 850 GS',
                'price' => 410.00,
            ...
            [
                ...
                'description' => 'Porta celular magnético para manillar. Próximamente disponible.',
                'category' => 'Accesorios',
                'brand' => 'Universal',
                'model' => 'Genérico',
                'price' => 99.00,
        ...
        foreach ($products as $data) {
            ...
            $galleryImages = $this->resolveImages($data);
            ...
            $this->syncProductVariants($product, $data, $galleryImages);
     ...
     */
    private function syncProductVariants(Product $product, array $data, array $galleryImages): void
    {
        $variantDefinitions = $this->normalizeVariantDefinitions($data);
        $seedSkus = [];

        foreach ($variantDefinitions as $definition) {
            $variantSku = $definition['sku'];
            $seedSkus[] = $variantSku;
            ...
            $this->syncVariantColors($variant, $definition['colors']);
            $this->syncVariantInventory($product, $variant, (int) $definition['stock']);
            $this->syncVariantImages($product, $variant, $galleryImages);
        }

        $this->removeStaleVariants($product, $seedSkus);
        $this->removeStaleProductImages($product);
    }

    private function removeStaleProductImages(Product $product): void
    {
        ...
        $product->images()
            ->where(function ($query) use ($variantIds) {
                ...
                if ($variantIds->isNotEmpty()) {
                    $query->orWhereNotIn('product_variant_id', $variantIds);
                }
            })
            ->delete();
    }
    ...
    /**
     * @param  array<string, mixed>  $data
     * @return list<array{sku: string, name: string, colors: list<string>, stock: int}>
     */
    private function normalizeVariantDefinitions(array $data): array
    {
        ...
        foreach ($data['variants'] as $index => $variant) {
            if (array_key_exists('stock', $variant)) {
                $explicitTotal += (int) $variant['stock'];
            } else {
                $autoIndexes[] = $index;
            }
        }

        $remaining = max(0, (int) $data['stock'] - $explicitTotal);
        $autoDistribution = $this->distributeStock($remaining, count($autoIndexes));

        foreach ($data['variants'] as $index => $variant) {
            $name = $variant['name'];
            $colors = array_values($variant['colors'] ?? []);
            $stock = array_key_exists('stock', $variant)
                ? (int) $variant['stock']
                : (array_shift($autoDistribution) ?? 0);

            $variants[] = [
                'sku' => $variant['sku'] ?? $this->buildVariantSku($data['sku'], $name, $colors),
                'name' => $name,
                'colors' => $colors,
                'stock' => $stock,
            ];
     ...
     */
    private function buildVariantSku(string $productSku, string $name, array $colors): string
    {
        $label = $colors[0] ?? $name;
        $slug = Str::upper(Str::slug(Str::ascii($label), '-'));

        return "{$productSku}-{$slug}";
    }

    /**
     * @param  list<string>  $colors
     */
    private function syncVariantColors(ProductVariant $variant, array $colors): void
    {
        $sync = [];

        foreach ($colors as $sortOrder => $colorName) {
            $color = Color::query()->updateOrCreate(
                ['name' => $colorName],
                ['hex' => self::COLOR_HEX[$colorName] ?? null],
            );

            $sync[$color->id] = ['sort_order' => $sortOrder];
        }

        $variant->colors()->sync($sync);
    }

    private function syncVariantInventory(Product $product, ProductVariant $variant, int $available): void
    {
    ...
    private function syncVariantImages(Product $product, ProductVariant $variant, array $images): void
    {
        ...
        foreach ($images as $index => $path) {
            // product_images tiene unique(product_id, path): distinguir por variante.
            $uniquePath = $path.(str_contains($path, '?') ? '&' : '?').'variant='.urlencode($variant->sku);
     ...
     */
    private function removeStaleVariants(Product $product, array $seedSkus): void
    {
        $product->variants()
            ->whereNotIn('sku', $seedSkus)
     ...
     * @return list<int>
     */
    private function distributeStock(int $total, int $parts): array
    {
        if ($parts <= 0) {
            return [];
        }
        ...
        $stocks = array_fill(0, $parts, $base);
    ...
    private function seedProductOffers(): void
    {
        $offers = [
            [
                ...
                'reason' => 'Promoción en cascos integrales',
            ],
            [
                'sku' => 'MW-MOTO-004',
                ...
                'reason' => 'Oferta de lanzamiento Pulsar NS200',
            ],
            [
                'sku' => 'MW-LUB-001',
                'offer_price' => 45.00,
            ...
            [
                ...
                'reason' => 'Preventa neumáticos urbanos',
            ],
        ];
        ...
        foreach ($offers as $data) {
            ...
            $discountPercent = $listPrice > 0 && $offerPrice < $listPrice
                ? round((($listPrice - $offerPrice) / $listPrice) * 100, 2)
                : null;
